...
void A05DriverNode::run() 
{
    ...
    ros::Timer pub_timer_ = nh.createTimer(ros::Duration(1.0 / 5), &A05DriverNode::pubTimerCallback, this);
    ros::Timer emergency_timer_ = nh.createTimer(ros::Duration(1.0 / rate), &A05DriverNode::emergencyTimerCallback, this);    
    ros::spin();
}
